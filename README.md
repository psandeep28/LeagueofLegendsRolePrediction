...
| **Position**  | **Kills (Mean)** | **Kills (Std)** | **Assists (Mean)** | **Assists (Std)** | **DPM (Mean)** | **DPM (Std)** | **Vision Score (Mean)** | **Vision Score (Std)** | **Total Gold (Mean)** | **Total Gold (Std)** | **Gold at 10 (Mean)** | **Gold at 10 (Std)** | **Gold Diff at 10 (Mean)** | **Gold Diff at 10 (Std)** |
|---------------|------------------|-----------------|--------------------|-------------------|----------------|---------------|-------------------------|------------------------|-----------------------|----------------------|-----------------------|----------------------|---------------------------|--------------------------|
